...
extern void attachInvokePort(long long mPort);
extern void quickStart(char* dirChar, char* paramsChar, char* stateParamsChar, long long port);
extern char* startTUN(int fd);
extern char* getRunTime();
extern void stopTun();
extern void setFdMap(char* fdIdChar);
